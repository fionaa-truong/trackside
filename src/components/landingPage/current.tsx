...
export default function Current({
  ...
  return (
    <div className="flex h-40 w-[350px] flex-col items-center gap-3 rounded-b-lg border-t-2 border-white bg-black text-blue-white md:h-24 md:w-[750px] md:flex-row md:gap-0 lg:h-32 lg:w-[850px]">
